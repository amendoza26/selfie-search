...
// Estado de autenticación
  ...
  displayedColumns: string[] = [
    'med_fechreg_fecha','med_fechreg_hora', 'platf_nomplatf', 'cplatf_cupon', 'tpdoc_desc', 'numdoc',
    'fullName', 'sexo', 'edad', 'celular', 'talla', 'peso',
  ...
  exportToExcel() {
    ...
    const dataToExport = this.dataSource.filteredData.map(row => {
      return {
        ...
        FrecuenciaRespiratoria: row.frec_respiratoria,
